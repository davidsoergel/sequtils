 ...
 *
 * @author David Tulga
 * @version $Id: SectionSFI.java 1324 2010-03-08 22:44:49Z soergel $
 */
public class SectionSFI extends SectionDecomposingSFI
	{
	// ------------------------------ FIELDS ------------------------------
 ...
 */
	...
	public SectionSFI(SectionList list) throws IOException
		{
		super(list);
	...
	protected synchronized SequenceFragment getNextWindow()
		...
		if (nextSectionTrigger)
			{
			currentSection = sectionList.next();
